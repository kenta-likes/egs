...
test_alarms(int* arg){
  ...
  set_alarm(25, print_alarm, (void*)3, sys_time);//t = 28
  sys_time += 3;
  set_alarm(10, print_alarm, (void*)4, sys_time);//t = 15
  set_alarm(20, print_alarm, (void*)5, sys_time);//t = 26
  set_alarm(5, print_alarm, (void*)6, sys_time);// t = 11
  sys_time += 2;
  set_alarm(1, print_alarm, (void*)7, sys_time);// t = 8
